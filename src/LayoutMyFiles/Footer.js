            ...
            <div className='footer-content container'>
                <div className='footer-list'>
                    ...
                    <form className='footer-form'>
                        <input name="text" type="text" value="Subscribe" placeholder="Subscribe" className='form-input' />
                        <span><Link to="#" className="socials-telegram fa-brands fa-telegram" /></span>
                    </form>
                    </div>
                </div>
                ...
                className='copyright-link'>by Colorlib</Link>
               </p>
            </div>
        </section>
